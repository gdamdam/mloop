/**
 * VuMeter — frequency spectrum visualizer for the header.
 * Ported from mpump VuMeter.tsx. Click to cycle between 3 styles.
 */
...
export function VuMeter({ getAnalyser }: VuMeterProps) {
